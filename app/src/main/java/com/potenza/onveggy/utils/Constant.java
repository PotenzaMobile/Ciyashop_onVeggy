...
import com.potenza.onveggy.model.Sort;
...
public class Constant {
    ...
    public static final String MyPREFERENCES = "com.potenza.onveggy"; // Add your package name

    public static final String PACKAGE_NAME = "com.potenza.onveggy";  // Add your package name

    //    public static final String DeepLinkDomain = "potenza.page.link";// Add your Deeplink Domain URL
    public static final String DeepLinkDomain = "https://rm5f5.app.goo.gl";// Add your Deeplink Domain URL

    public static final String DynamicLinkIosParameters = "com.potenza.onveggy"; // Add your Deeplink IOS package name if you have
