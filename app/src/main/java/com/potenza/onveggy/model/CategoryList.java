...
public class CategoryList {
    ...
    @Expose
    public List<Integer>   relatedIds        = new ArrayList<>();
    @SerializedName("upsell_ids")
    @Expose
    public List<Object>    upsellIds         = new ArrayList<>();
    @SerializedName("cross_sell_ids")
    @Expose
    public List<Object>    crossSellIds      = new ArrayList<>();
    ...
    @Expose
    public List<Object>    defaultAttributes = new ArrayList<>();
    @SerializedName("variations")
    @Expose
    public List<Integer>   variations        = new ArrayList<>();
    @SerializedName("grouped_products")
    @Expose
    public List<Integer>   groupedProducts   = new ArrayList<>();
