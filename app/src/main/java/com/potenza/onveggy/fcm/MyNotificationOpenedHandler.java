...
import com.potenza.onveggy.utils.MyApplication;
...
//               Log.e("OneSignalpotenza", "customkey set with value: " + activityToBeOpened);
...
//        }
        ...
        if (actionType == OSNotificationAction.ActionType.ActionTaken) {
            Log.e("OneSignalpotenza", "Button pressed with id: " + result.action.actionID);
