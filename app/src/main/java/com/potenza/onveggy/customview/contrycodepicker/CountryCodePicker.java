package com.potenza.onveggy.customview.contrycodepicker;
...
import com.potenza.onveggy.BuildConfig;
import com.potenza.onveggy.R;
import com.potenza.onveggy.customview.libphonenumber.NumberParseException;
import com.potenza.onveggy.customview.libphonenumber.PhoneNumberUtil;
import com.potenza.onveggy.customview.libphonenumber.Phonenumber;
...
public class CountryCodePicker extends RelativeLayout {
     ...
     *                   (country_code+carrier_number) for potenza if country is India (+91) and carrier/mobile number
    ...
    private void setPhoneNumberHint() {
        ...
        Phonenumber.PhoneNumber phoneNumber = mPhoneUtil.getpotenzaNumberForType(iso, mobile);
        if (phoneNumber == null) {
