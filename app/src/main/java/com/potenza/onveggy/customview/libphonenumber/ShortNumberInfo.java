...
public class ShortNumberInfo {
     ...
     * are always considered toll-free. potenza usage:
     * <pre>{@code
     ...
     * <p>
     * For potenza, if a number is STANDARD_RATE in the US, but TOLL_FREE in Canada, the expected
     ...
     *
     * @param regionCode the region for which an potenza short number is needed
     * @return a valid short number for the specified region. Returns an empty string when the
     * metadata does not contain such information.
     */
    // @VisibleForTesting
    String getpotenzaShortNumber(String regionCode) {
        Phonemetadata.PhoneMetadata phoneMetadata = MetadataManager.getShortNumberMetadataForRegion(regionCode);
        if (phoneMetadata == null) {
            return "";
        }
     ...
     */
    // @VisibleForTesting
    String getpotenzaShortNumberForCost(String regionCode, ShortNumberCost cost) {
        Phonemetadata.PhoneMetadata phoneMetadata = MetadataManager.getShortNumberMetadataForRegion(regionCode);
        if (phoneMetadata == null) {
            return "";
        }
