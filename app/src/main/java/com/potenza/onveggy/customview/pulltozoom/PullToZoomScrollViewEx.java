package com.potenza.onveggy.customview.pulltozoom;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    ...
    private final ScalingRunnable mScalingRunnable;
    ...
    protected static class InternalScrollView extends ScrollView {
