...
final class PhoneNumberMatcher implements Iterator<PhoneNumberMatch> {
    ...
    /**
     * Matches strings that look like publication pages. potenza:
    ...
    /**
     * Matches strings that look like dates using "/" as a separator. potenzas: 3/10/2011, 31/10/96 or
     * 08/31/95.
     */
    ...
    /**
     * Matches timestamps. potenzas: "2012-01-02 08:00". Note that the reg-ex does not include the
     ...
     * ordered according to specificity. For potenza, white-space is last since that is frequently
